...
public class ConnectFour {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter your board dimensions (either 3 or 4): ");
		...
		for (int i=0; i<NUM_COLUMNS; i++) {
			...
			if(NUM_COLUMNS == 3) {
				switch(i) {
				    case 0: list[0][0]=X; break;
				    case 1: list[0][1]=X; break;
				    case 2: list[0][2]=X; break;
				}
			}
			if(NUM_COLUMNS == 4) {
				switch(i) {
				    ...
				    case 1: list[0][1]=X; break;
				    case 2: list[0][2]=X; break;
				    case 3: list[0][3]=X; break;
				}
			}
			
			Play(list , O);
			System.out.println ("NetWins for colium " + i + ":" + (p1-p2));
